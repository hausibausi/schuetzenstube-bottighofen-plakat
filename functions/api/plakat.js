// Cloudflare Pages Function: POST /api/plakat
// Ruft OpenAI serverseitig auf; der Schlüssel liegt als geheime Env-Variable OPENAI_API_KEY.
...
export async function onRequestPost(context) {
  ...
  const gerichte = Array.isArray(body.gerichte)
