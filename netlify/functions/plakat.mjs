// Netlify Function (Node) – ruft OpenAI serverseitig auf.
// Schluessel aus Umgebungsvariable OPENAI_API_KEY (nie im Browser sichtbar).
...
export default async (req) => {
  ...
  let body;
  try { body = await req.json(); } catch { return json({ error: "Ungültige Anfrage." }); }
